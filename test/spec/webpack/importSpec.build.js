...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_____default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0____);
 //as used in https://github.com/swagger-api/swagger-js/blob/397fc7af59eff1bf1608b580049dddf61da82b96/src/specmap/lib/index.js#L1
...
describe('This package imported by Webpack', function () {
    describe('import default', function () {
        it('should have the expected structure', function () {
            verifyObjectStructure(__WEBPACK_IMPORTED_MODULE_0_____default.a);
        });
    });

    describe('import asterisk', function () {
        it('should have the expected structure', function () {
            verifyObjectStructure(__WEBPACK_IMPORTED_MODULE_0____);
        });
    });

    describe('named import', function () {
        it('should have the expected structure', function () {
            expect(__WEBPACK_IMPORTED_MODULE_0____["applyOperation"]).toBeDefined();
        });
    });
});
