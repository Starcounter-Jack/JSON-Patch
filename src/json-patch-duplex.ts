...
module jsonpatch {
   ...
   export function observe(obj: any, patches:any[], parent:any) : any {
      var root = obj;
      if (Object.observe) {
   ...
   function _observe(observer:any,obj: any, patches:any[], parent:any) : any {
      if (Object.observe)
   ...
   export function generate(obj,observer) {
      if (Object.observe) {
